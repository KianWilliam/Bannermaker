...
defined('_JEXEC') or die;
 ...
 $document = JFactory::getDocument();
  $document->addStyleSheet(JURI::Base()."components/com_bannermaker/assets/css/banner.css");  
...
<div  id="mbannermaker" class="<?php echo $class; ?>" >
		 <?php
		   $dispatcher->trigger('onContentPrepare', array('mod_bannermaker', &$row, &$params, 0 ) );
		 ?>
</div>
