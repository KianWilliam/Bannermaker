...
class BannermakerControllerBanners extends JControllerAdmin
{
	public function getModel($name = 'Banner', $prefix = 'BannermakerModel', $config = array('ignore_request' => true))
	{
