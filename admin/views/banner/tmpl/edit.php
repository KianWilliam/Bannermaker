...
<form action="<?php echo JRoute::_('index.php?option=com_bannermaker&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="banner-form" class="form-validate">
               <div class="width-60 fltlft">
				    <fieldset class="adminform">
						<legend><?php echo empty($this->item->id) ? JText::_('COM_BANNERMAKER_NEW') : JText::sprintf('COM_BANNERMAKER_BANNER_SETTINGS', $this->item->id); ?></legend>
